...
enum class MessageConstants(var message: String) {
    ...
    SUCCESSFUL_LEAVE_PARKING_LOT("Registration Number %s from Lot %d has left with Charge %d"),
    SUCCESSFUL_ALLOCATED_PARKING_LOT("Allocated lot number: %d"),
    ...
    EXCEPTION_ALREADY_PARKED("Sorry, Registration Number %s already parked"),
